...
import {
  provideThinkingDeps, buildThoughtsDisclosure, ensureThinkingBubble,
  updateThinkingBubble, setThinkingMilestone, pushReasoning,
...
provideThinkingDeps({
  ...
  // Read-only views onto transcript state the bubble consults.
