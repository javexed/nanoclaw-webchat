...
| [coverage-guards.md](coverage-guards.md) | The two guards and what each really checks — what `app-manifest.txt` governs (migrations register, dev tree matches), which guard is permanent, and how to retire the fork half |
