...
| [coverage-guards.md](coverage-guards.md) | What `app-manifest.txt` really governs (migrations register, dev tree matches), how the guard is proven to still detect faults, why the fork-diff guard was retired, and what that leaves uncovered |
