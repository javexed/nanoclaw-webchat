...
# The escalation logic is a module, not a patch — reversing the patches
# unwires it (09-index drops the armEscalation call) but leaves the files.
rm -f container/agent-runner/src/escalation.ts container/agent-runner/src/escalation.test.ts
