...
const API_ROUTES: ApiRoute[] = [
  ...
  { method: 'POST', path: '/api/ollama/install', guards: ['csrf', 'owner'], h: rOllamaInstallPost, audit: 'provider.install' },
  { method: 'GET', path: '/api/codex/install', guards: ['owner'], h: rCodexInstallGet },
  { method: 'POST', path: '/api/codex/install', guards: ['csrf', 'owner'], h: rCodexInstallPost, audit: 'provider.install' },
  { method: 'GET', path: '/api/grok/install', guards: ['owner'], h: rGrokInstallGet },
  { method: 'POST', path: '/api/grok/install', guards: ['csrf', 'owner'], h: rGrokInstallPost, audit: 'provider.install' },
  { method: 'GET', path: '/api/opencode/install', guards: ['owner'], h: rOpencodeInstallGet },
  { method: 'POST', path: '/api/opencode/install', guards: ['csrf', 'owner'], h: rOpencodeInstallPost, audit: 'provider.install' },
  ...
  { method: 'POST', path: '/api/router/install', guards: ['csrf', 'owner'], h: rRouterInstallPost, audit: 'provider.install' },
