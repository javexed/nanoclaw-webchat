...
describe('claimClientId — inbound message idempotency', () => {
  it('first claim is fresh; an immediate repeat is a duplicate', async () => {
  ...
  it('the same id is claimable again once the window has elapsed', async () => {
  ...
  it('distinct ids never collide', async () => {
