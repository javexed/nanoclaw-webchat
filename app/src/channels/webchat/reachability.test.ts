...
describe('classifyReachability', () => {
  it('connected with a 2xx/4xx status → ok', () => {
  ...
  it('connected but HTTP 5xx → incompatible (reachable, wrong/broken API)', () => {
  ...
  it('TCP timeout → timeout with a firewall fix (ufw rule for the docker bridge)', () => {
  ...
  it('ECONNREFUSED → refused with a 0.0.0.0 bind fix', () => {
