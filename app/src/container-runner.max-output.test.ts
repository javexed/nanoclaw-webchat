...
describe('maxOutputTokensFor', () => {
  it('gives current models their real ceiling', async () => {
  ...
  it('does NOT claim a ceiling for older models that merely share a family name', async () => {
  ...
  it('returns null for non-Claude and unknown strings so the var stays unset', async () => {
  ...
  it('treats an unconfigured model as the provider default (Opus-class)', async () => {
  ...
  it('lets the env override win over everything, including unknown models', async () => {
  ...
  it('ignores a junk or non-positive override', async () => {
